...
#
JVM_SUPPORT_RECOMMENDED_ARGS="-Xdebug -Xrunjdwp:transport=dt_socket,address=5005,server=y,suspend=n -Datlassian.dev.mode=true -Dquickreload.tracked=/home/tbar/testflo/suitest -Dplugin.resource.directories=/home/tbar/testflo/suitest/target/generated-resources -DenableDangerousBackdoorForIntegrationTests=true"
